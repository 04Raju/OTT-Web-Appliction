...
// }
  ...
  $sql ="INSERT into musics_db (Song_Artist,Song_Album,Song_Name,Song_Type,Song_Lang,Song_Catag,Song_Link,Status,Song_Poster) 
  VALUES('$sartists','$salbum','$sname','$stype','$slanuage','$scatag','$slink','Active','$mposter')";
...
<table class="table table-striped table-bordered  table-hover bg-light text-dark" id='UserList'>
  ...
  <tbody>
    ...
    $sql="SELECT *, musics_db.Status as Mstatus FROM musics_db, song_albumdb, artists_db WHERE artists_db.artists_Id= musics_db.Song_Artist  and musics_db.Song_Album = song_albumdb.Sr_no";
      ...
      <td class="text-center "scope="row"style=""><?php echo $row['Mstatus']?></td>
<!--      <td class="text-center "scope="row"style=""><a type='button' class="nav_link"  data-toggle="modal" data-target="#EditSongModal" onclick="EditSong('<?php echo $row['songs_Id']?>','<?php echo $row['Song_Artist']?>','<?php echo $row['Song_Album']?>','<?php echo $row['Song_Name']?>','<?php echo $row['Song_Type']?>','<?php echo $row['Song_Lang']?>','<?php echo $row['Song_Catag']?>','<?php echo $row['Song_Link']?>','<?php echo $row['Status']?>','<?php echo $row['Song_Poster']?>','<?php echo $row['playlist']?>')">Edit </a></td>-->
      ...
      <td class="text-center "scope="row"style=""><a  class="text-danger"href="Control panel/EditSong.php/?d=<?php echo $row['songs_Id']?>">Delete</a></td>
    </tr>
    <?php
    $sr++;
}
