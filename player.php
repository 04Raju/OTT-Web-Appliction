...
$row= mysqli_fetch_assoc($query);
    ?>
    <title>Now Playing :- <?php echo$row['Movie_Name']?>Movie</title>
        ...
        <?php
            ...
            if($num>=0){
             while ( $row = mysqli_fetch_array($quariy) ) {
               ?>
  <iframe src="https://drive.google.com/file/d/<?php echo$row['Movie_ML']?>/preview" frameborder="0"  allow="autoplay; accelerometer" scrolling="no" seamless="" allowfullscreen></iframe>
<?php
}
     }
?>
